...
![](<../.gitbook/assets/attachment353d8f4a e6b5 4660 baa2 586fdb24692cimage (2).png>) ![](<../.gitbook/assets/attachmentc196f203 c54f 480b a66a 436b7a4b88bdimage (2).png>)
{% endstep %}
...
{% step %}
Select **Train Now** to proceed to the [Training Method](training-method.md).

<div align="center" data-with-frame="true"><figure><img src="../.gitbook/assets/screencapture-dev-chatlyst-io-app-chat-uat-2026-04-29-12_59_32 (1) (1).png" alt="" width="375"><figcaption></figcaption></figure></div>
{% endstep %}
{% endstepper %}
