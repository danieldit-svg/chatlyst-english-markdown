---
description: This guide explains how to top up credits in Chatlyst.
icon: lightbulb-dollar
---

# Top Up Guideline

Chatlyst uses two credit types, and each one supports a different function.

* **Knowledge Consolidation Bot Credits (KC Bot)** — Used to train and update business knowledge.
* **AI Response Credits** — Used for AI bot chat handling, including generating and sending responses during conversations.
...
{% step %}
The Purchase Credits window appears after selecting the credit type.
...
{% step %}
In the Complete Purchase window, enter payment details, then select **Pay** to submit payment and complete the purchase.

<div><figure><img src="../.gitbook/assets/image (22).png" alt=""><figcaption></figcaption></figure> <figure><img src="../.gitbook/assets/image (23).png" alt=""><figcaption></figcaption></figure></div>
{% endstep %}

{% step %}
**Other Options:**

* Save purchase information — Select the checkbox to save purchase information for faster checkout next time.

<div data-with-frame="true"><figure><img src="../.gitbook/assets/image (24).png" alt="" width="375"><figcaption></figcaption></figure></div>

* Breakdown — Select **View Details** to review the purchase breakdown before payment.

<div data-with-frame="true"><figure><img src="../.gitbook/assets/image (27).png" alt="" width="375"><figcaption></figcaption></figure></div>

<div data-with-frame="true"><figure><img src="../.gitbook/assets/image (26).png" alt="" width="375"><figcaption></figcaption></figure></div>

* Quick checkout with Link — If there is a Link account, select **Pay with Link** for faster checkout.

<div data-with-frame="true"><figure><img src="../.gitbook/assets/image (28).png" alt="" width="375"><figcaption></figcaption></figure></div>
{% endstep %}
{% endstepper %}
...
<div data-with-frame="true"><figure><img src="../.gitbook/assets/image (128).png" alt="" width="375"><figcaption></figcaption></figure></div>

* The invoice and receipt templates are shown below:

<div><figure><img src="../.gitbook/assets/image (129).png" alt="" width="563"><figcaption><p>Invoice</p></figcaption></figure> <figure><img src="../.gitbook/assets/image (132).png" alt="" width="563"><figcaption><p>Receipt</p></figcaption></figure></div>
