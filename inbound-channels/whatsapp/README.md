---
description: This guide shows how to manage the WhatsApp channel.
icon: whatsapp
---
...
If you registered using the WhatsApp Business App, you will retain full access to the application. Messages are synchronized across both Chatlyst ([Chat](https://app.gitbook.com/s/BW7n4ClAhZvbgvusylCd/chat) section) and the WhatsApp Business App.
...
In the WhatsApp channel, if no customer message is received within 24 hours, the Chatlyst chat session will automatically close.

* You may continue replying via the WhatsApp Business App, and your messages will still appear in Chatlyst under the same conversation.
...
Chatlyst does not sync historical messages from the WhatsApp Business App. Only messages within active Chatlyst sessions will be visible in the platform.
...
To add a widget, select **Add Widget (Connet Whatsapp Number)** to launch the widget setup flow. For additional context, follow [Add a Widget](add-a-widget.md).
