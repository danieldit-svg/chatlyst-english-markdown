...
In the Instagram channel, select **Add Widget (Connect Instagram Account)**.

<div data-with-frame="true"><figure><img src="../../.gitbook/assets/image (707) (1).png" alt="" width="375"><figcaption></figcaption></figure></div>
...
After you create a widget, the next page opens automatically so you can review the widget details. Select **Connect with Instagram** to to initiate the process of linking a Instagram.

<div data-with-frame="true"><figure><img src="../../.gitbook/assets/image (711) (1).png" alt=""><figcaption></figcaption></figure></div>
{% endstep %}
{% endstepper %}
