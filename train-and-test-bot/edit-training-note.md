---
description: >-
  This guide explains how to update the training note for a ticket that has
  already been submitted, so the training information stays accurate even after
...
* [Send to KC Bot](training-method.md#send-to-kc-bot-training)
* [Manual Training](training-method.md#manual-training)

<div data-with-frame="true"><img src="../.gitbook/assets/attachment61b81b61 db80 4bce 9bcb 3e32a960d862926521a1 b71f 477f 801e 405291e4a458 (2).png" alt=""></div>
